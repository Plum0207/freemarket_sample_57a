10.times do |number|
    Item.create!(id: "#{number+1}", seller_id: 2, name: "レディース", description: "[激レア] 良品です!!", category_id: 32, size: 0, brand_id: 8, condition: 0, postage_burden: 0, sending_method: 0, prefecture_from: 0, shipping_date: 0, price: 999)
  end
...
10.times do |number|
  Item.create!(id: "#{number+21}", seller_id: 1, name: "家電・スマホ・カメラ", description: "[激レア] 良品です!!", category_id: 920, size: 0, brand_id: 8, condition: 0, postage_burden: 0, sending_method: 0, prefecture_from: 0, shipping_date: 0, price: 999)
end

10.times do |number|
  Item.create!(id: "#{number+31}", seller_id: 1, name: "おもちゃ・ホビー・グッズ", description: "[激レア] 良品です!!", category_id: 715, size: 0, brand_id: 8, condition: 0, postage_burden: 0, sending_method: 0, prefecture_from: 0, shipping_date: 0, price: 999)
end
